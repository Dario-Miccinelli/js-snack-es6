...
const mapName = students.map ((students) => {
...
const votiStudenti = students.filter ((students) => {
...
const filteredItems = students.filter((students) => {

return students.id  >= 120 & students.grades >= 70;
